...
/*
 * force processor shutdown, for those machines where kbd rst
 * just is not enough.
 */
force_shutdown() {

	lidt(idt, 0);			/* make idt invalid */
	asm ("movl	$0, %esp");	/* likewise, make stack invalid */
					/* blown away on return! */
}
